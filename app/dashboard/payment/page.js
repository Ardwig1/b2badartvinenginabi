        ...
        <div className="page-wrapper">
            ...
            <div className="payment-layout" style={{ display: 'flex', gap: 24, maxWidth: 900, margin: '0 auto', alignItems: 'stretch' }}>
                <div className="payment-main" style={{ flex: '1 1 500px', display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    {/* QNB Finansbank Banner */}
                    <div style={{ padding: '16px 24px', background: '#e2e8f0', border: '1px solid #cbd5e1', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '16px', color: '#002b5b' }}>
                    ...
                    <div className="card payment-form-card" style={{ padding: 30 }}>
                        ...
                        <div className="form-group"><label className="form-label">Ödenecek Tutar (₺)</label><input type="text" inputMode="decimal" className="form-input" style={{ fontSize: 24, fontWeight: 'bold', color: 'var(--primary)', background: 'var(--bg-input)' }} value={amount} onChange={e => handleAmountChange(e.target.value)} /></div>
                        ...
                        >
                            {qnbpayLoading ? (
                                <><span className="loading-spinner" style={{ width: 18, height: 18, borderWidth: 2 }} /> Yönlendiriliyorsunuz...</>
                            ) : (
                                '🔒 Güvenli Ödeme Yap'
                            )}
                        </button>
