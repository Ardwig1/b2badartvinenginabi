export default function MesafeliSatisSozlesmesi() {
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', lineHeight: '1.6', color: '#f0f0f0' }}>
            ...
            <h3 style={{ marginTop: '20px' }}>MADDE 3 - SÖZLEŞME KONUSU ÜRÜN BİLGİLERİ</h3>
            <p>
                Malın/Ürünün/Hizmetin türü, miktarı, marka/modeli, rengi, adedi, satış bedeli, ödeme şekli, siparişin sonlandığı andaki
            ...
            <p>
                4.2. Sözleşme konusu ürün, yasal 30 günlük süreyi aşmamak koşulu ile her bir ürün için ALICI'nın yerleşim yerinin uzaklığına
                bağlı olarak internet sitesinde ön bilgiler içinde açıklanan süre zarfında ALICI veya gösterdiği adresteki kişi/kuruluşa teslim edilir.
            </p>
            <p>
                4.3. SATICI, sözleşme konusu ürünün sağlam, eksiksiz, siparişte belirtilen niteliklere uygun ve varsa garanti belgeleri ve
                kullanım kılavuzları ile teslim edilmesinden sorumludur.
            </p>

            <h3 style={{ marginTop: '20px' }}>MADDE 5 - CAYMA HAKKI VE B2B İŞLEMLERİ</h3>
            <p>
                İşbu portal B2B (Bayiden Bayiye) işlemlerine yönelik olduğundan, kurumsal alımlarda Tüketici Kanunundaki bağlayıcı cayma hakkı
                koşulları, Türk Ticaret Kanunu hükümleri çerçevesinde yeniden değerlendirilmektedir. İade ve iptal koşulları, "İptal ve İade Koşulları"
                sayfasında ayrıca belirtilmiştir.
            </p>
