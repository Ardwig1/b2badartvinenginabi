    ...
    try {
        ...
        for (const brand of TARGET_BRANDS) {
            ...
            const [stockRes, priceRes] = await Promise.all([
                axios.get(`${PROXY_URL}/material/StokGetir?ListeGrubu=${brand}&FirmaAdi=BASBUG&Depo=MRK`, apiConfig),
                axios.get(`${PROXY_URL}/material/FiyatGetir?ListeGrubu=${brand}&FirmaAdi=BASBUG`, apiConfig)
            ]);
            ...
            // Only process items that have stock
